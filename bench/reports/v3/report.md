...
**20 specs × 2 models = 40 (spec, model) cells.**

## Headline

**`gemma4:12b` (shadow) leads** on the corpus — compiled 90% of submissions and passed the full golden suite on 85%, with mean golden 4.40.

The routing rule's current primary is `gemma4:e4b` (compile 90%, golden 5/5 85%, avg golden 4.30) — a candidate to demote in favor of `gemma4:12b` for this task type.
...
|---|---|---:|---:|---:|---:|---:|---:|
| `gemma4:12b` | shadow | 20 | 90% | 85% | 4.40 | 87% | 4.67 |
| `gemma4:e4b` | job | 20 | 90% | 85% | 4.30 | 93% | 4.73 |
